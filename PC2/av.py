...
azul_bajo = np.array([0,0,98])
azul_alto = np.array([360,100,100])
rojo_bajo = np.array([0,0,0])
rojo_alto = np.array([350,55,100])
...
rojo_alto1 = np.array([357, 88, 92])
rojo_bajo2 = np.array([354,69,71])
rojo_alto2 = np.array([350, 55, 100])
